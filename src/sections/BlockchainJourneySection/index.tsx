...
const steps = [
  {
    ...
    icon: "https://www.theFxCapital.com/assets/homepage/your-blockchain-journey-starts-with-FxCapital/consultation_and_discovery.webp"
  },
  {
    number: "02",
    title: "Strategy & Planning",
    description: "Our experts create a comprehensive roadmap tailored to your business needs",
    icon: "https://www.theFxCapital.com/assets/homepage/your-blockchain-journey-starts-with-FxCapital/strategy_and_planning.webp"
  },
  {
    number: "03",
    title: "Design & Development",
    description: "We build your solution using cutting-edge technologies and best practices",
    icon: "https://www.theFxCapital.com/assets/homepage/your-blockchain-journey-starts-with-FxCapital/design_and_development.webp"
  },
  {
    number: "04",
    title: "Testing & Quality Assurance",
    description: "Rigorous testing ensures your platform is secure, scalable, and bug-free",
    icon: "https://www.theFxCapital.com/assets/homepage/your-blockchain-journey-starts-with-FxCapital/testing_and_quality_assurance.webp"
  },
  {
    number: "05",
    title: "Deployment & Launch",
    description: "We handle the complete deployment process and ensure a smooth launch",
    icon: "https://www.theFxCapital.com/assets/homepage/your-blockchain-journey-starts-with-FxCapital/deployment_and_launch.webp"
  },
  {
    number: "06",
    title: "Support & Maintenance",
    description: "Ongoing support, updates, and optimization to keep your platform running perfectly",
    icon: "https://www.theFxCapital.com/assets/homepage/your-blockchain-journey-starts-with-FxCapital/support_and_maintenance.webp"
  }
];
      ...
      <div className="box-border caret-transparent max-w-[1400px] mx-auto px-4">
        ...
        >
          <h2 className="text-gray-900 text-4xl font-bold box-border caret-transparent leading-[54px] mb-4">
            Your Blockchain Journey Starts With <span className="text-sky-500">FxCapital</span>
          </h2>
